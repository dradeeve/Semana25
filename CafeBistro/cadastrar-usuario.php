...
<main>
    ...
    <section class="container-form">
        <form action="processar-cadastro.php" method="post">
            ...
            <input type="text" id="nome" c placeholder="Digite o nome do produto" required>
            ...
            <input type="password" id="confirmar senha" name="confirmar senha " placeholder="Digite novamente a senha">
            <?php if (isset($_GET)){
                echo "<label for='erro'>Senha  e confirmaçao de senha não coincidem</label>";0
            }?>
